...
class Settings(BaseSettings):
    ...
    # Email
    SENDGRID_API_KEY: Optional[str] = None  # deprecated/not used
    SENDGRID_FROM_EMAIL: str = "noreply@thecastle.de"  # deprecated/not used
    CONTACT_EMAIL: str = "reservations@thecastleberlin.de"
    # Zoho (optional)
